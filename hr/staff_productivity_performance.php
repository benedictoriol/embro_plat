...
$active_workload_placeholders = order_workflow_status_placeholders($active_workload_statuses);
...
$performance_stmt = $pdo->prepare("
    SELECT u.id AS user_id,
           ...
           COUNT(CASE WHEN o.status IN ($active_workload_placeholders) THEN 1 END) AS active_orders,
...
");
$performance_stmt->execute(array_merge([$shop_id, $shop_id], $active_workload_statuses));
