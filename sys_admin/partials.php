...
function sys_admin_nav(string $activePage): void {
    ...
    $unreadNotifications = ($adminId > 0 && isset($pdo) && $pdo instanceof PDO) ? fetch_unread_notification_count($pdo, $adminId) : 0;
    $navItems = [
    ...
    $userItems = [
        ...
        ['key' => 'user_access_control', 'label' => 'Access Control', 'icon' => 'fas fa-user-shield', 'href' => 'user_access_control.php'],
    ];
    $systemItems = [
        ...
        ['key' => 'notifications', 'label' => 'Inbox', 'icon' => 'fas fa-bell', 'href' => 'notifications.php'],
                    ...
                    <li>
                        <a href="<?php echo $item['href']; ?>" class="nav-link <?php echo $activePage === $item['key'] ? 'active' : ''; ?>">
                            ...
                            <?php if ($item['key'] === 'notifications' && $unreadNotifications > 0): ?>
                                <span class="badge badge-danger"><?php echo (int) $unreadNotifications; ?></span>
                            <?php endif; ?>
                        </a>
                    </li>
                <?php endforeach; ?>
