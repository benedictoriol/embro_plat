...
$owner_snapshot = null;
if (function_exists('fetch_owner_onboarding_snapshot') && isset($pdo, $_SESSION['user']['id'])) {
    $owner_snapshot = fetch_owner_onboarding_snapshot((int) $_SESSION['user']['id'], $pdo);
}

$owner_state = $owner_snapshot['state'] ?? '';
$is_pending_owner = $owner_state !== 'approved';
$brand_href = match ($owner_state) {
    'no_shop' => 'create_shop.php',
    'profile_incomplete', 'rejected' => 'shop_profile.php',
    'awaiting_approval' => 'awaiting_approval.php',
...
$active_groups = [
    ...
    'staff' => ['manage_staff.php', 'edit_employee.php', 'create_hr.php'],
...
<nav class="navbar navbar--compact">
    <div class="container d-flex justify-between align-center">
        <div class="d-flex align-center gap-4">
            <a href="<?php echo $brand_href; ?>" class="navbar-brand">
        ...
        <ul class="navbar-nav">
            <?php if ($is_pending_owner): ?>
                <?php if ($owner_state === 'no_shop'): ?>
                    <li><a href="create_shop.php" class="nav-link <?php echo $current_page === 'create_shop.php' ? 'active' : ''; ?>"><i class="fas fa-shop"></i> Create Shop</a></li>
                <?php else: ?>
                    <li><a href="shop_profile.php" class="nav-link <?php echo $current_page === 'shop_profile.php' ? 'active' : ''; ?>"><i class="fas fa-store"></i> Shop Profile</a></li>
                    <li><a href="awaiting_approval.php" class="nav-link <?php echo $current_page === 'awaiting_approval.php' ? 'active' : ''; ?>"><i class="fas fa-hourglass-half"></i> Pending Approval</a></li>
                <?php endif; ?>
            ...
            <li><a href="support_management.php" class="nav-link <?php echo $current_page === 'support_management.php' ? 'active' : ''; ?>"><i class="fas fa-life-ring"></i> Support Tickets</a></li>
            <li><a href="exception_dashboard.php" class="nav-link <?php echo $current_page === 'exception_dashboard.php' ? 'active' : ''; ?>"><i class="fas fa-triangle-exclamation"></i> Exceptions</a></li>
