...
if(isset($_POST['submit_rating'])) {
    ...
    ");
        ...
        if(!$order) {
            $error = 'Ratings are available after an order is completed and delivered or claimed.';
...
<body>
    ...
    <div class="container">
        <div class="dashboard-header">
            ...
            <p class="text-muted">Rate completed orders whose latest fulfillment update is delivered or claimed. This page also lists eligible completed orders, even those you already rated.</p>
        </div>
