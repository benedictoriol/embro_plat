        ...
        <?php else: ?>
            ...
            <div class="card">
             ...
             <div class="card mt-4">
                ...
                <details class="mt-2">
                    <summary class="text-primary">Need full details?</summary>
                    <div class="text-muted mt-2">Complete pricing, custom options, and project specifics are available inside each product card and during checkout.</div>
                </details>
            </div>
            </div>
            ...
            <div class="card mt-4">
                <div class="card-header">
                    ...
                    <p class="text-muted">Compact preview cards. Open each image for full-size details.</p>
                </div>
                            ...
                            <div class="portfolio-card">
                                <img src="../assets/uploads/<?php echo htmlspecialchars($item['image_path']); ?>" alt="<?php echo htmlspecialchars($item['title']); ?>">
                                 <div class="portfolio-card-body">
                                    ...
                                    <?php endif; ?>
                                    <p class="text-muted mb-0"><?php echo htmlspecialchars(mb_strimwidth((string) ($item['description'] ?? ''), 0, 120, '…')); ?></p>
                        ...
                        <?php foreach ($available_products as $product): ?>
                            <div class="product-item">
                                ...
                                <?php if (!empty($product['description'])): ?>
                                    <p class="text-muted mb-0"><?php echo htmlspecialchars(mb_strimwidth((string) $product['description'], 0, 110, '…')); ?></p>
                                <?php endif; ?>
