...
$editable_statuses = order_workflow_active_statuses();
$editable_status_placeholders = order_workflow_status_placeholders($editable_statuses);
...
$orders_stmt = $pdo->prepare("
    ...
    WHERE o.client_id = ? AND o.status IN ($editable_status_placeholders)
    ORDER BY o.created_at DESC
");
$orders_stmt->execute(array_merge([$client_id], $editable_statuses));
...
if(isset($_POST['update_design'])) {
    ...
    $order_stmt = $pdo->prepare("
        ...
        FROM orders
        WHERE id = ? AND client_id = ? AND status IN ($editable_status_placeholders)
    ");
    $order_stmt->execute(array_merge([$order_id, $client_id], $editable_statuses));
