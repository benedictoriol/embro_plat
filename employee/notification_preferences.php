...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    foreach ($notification_options as $event_key => $label) {
        ...
        $pref_stmt->execute([$employee_id, $event_key]);
        ...
        if ($pref_id) {
            ...
            $insert_stmt->execute([$employee_id, $event_key, $enabled]);
        }
    }
...
<body>
    ...
    <div class="container">
        <div class="dashboard-header">
            ...
            <p class="text-muted">Toggle the alerts you want to see for your assigned work.</p>
        </div>
